...
import { IMAGE_DECODE_DELAY, IMAGE_QUALITY, TABLE_LINE_THRESHOLD } from '../constants/pdf-extraction.constants';
 ...
 * @returns 추출된 이미지 배열
 */
async function extractImages(pageInfo: PDFPageProxy, imageNames: string[], pageNum: number): Promise<Images[]> {
    const images: Images[] = [];
